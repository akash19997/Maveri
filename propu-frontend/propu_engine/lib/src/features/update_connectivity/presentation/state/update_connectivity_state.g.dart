...
_$UpdateConnectivityStateImpl _$$UpdateConnectivityStateImplFromJson(
        Map<String, dynamic> json) =>
    _$UpdateConnectivityStateImpl(
      $type: json['runtimeType'] as String?,
    );

Map<String, dynamic> _$$UpdateConnectivityStateImplToJson(
        _$UpdateConnectivityStateImpl instance) =>
    <String, dynamic>{
