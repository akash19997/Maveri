...
class _TermsAndConditionsPageState extends State<TermsAndConditionsPage>
  ...
  LegalPolicyCubit _policyCubit = getIt<LegalPolicyCubit>();
  ValueNotifier<LegalPolicyResponse?> _valueResponse =
      ValueNotifier<LegalPolicyResponse?>(null);
  @override
  void initState() {
    super.initState();
    _policyCubit.fetchPolicies(
      request: LegalPolicyRequest(policy_type: "terms-conditions"),
    );
  }
