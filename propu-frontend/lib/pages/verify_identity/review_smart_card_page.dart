...
@RoutePage()
class ReviewSmartCardPage extends StatefulWidget {
  const ReviewSmartCardPage({super.key});

  @override
  State<ReviewSmartCardPage> createState() => _ReviewSmartCardPageState();
}

class _ReviewSmartCardPageState extends State<ReviewSmartCardPage> with StatefulLayoutMixin {
  @override
  Widget body() {
